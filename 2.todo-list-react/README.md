...
Основной фокус — управление состоянием через Redux Toolkit и работа с API.
...
* Вынес логику фильтрации в HOC (withFilter), чтобы переиспользовать её между компонентами
